...
export default (props) => {
    ...
    const onSaveClick = (button) => {
        api.bresource.saveOrUpdateButton(button).subscribe({
            next: () => {
    ...
    return (
        ...
        >
            ...
            <ILayout type="vbox">
                <IFormItem name="resourceId" label="资源ID" xtype="input" disabled labelCol={{ flex: '110px' }} />
                <IFormItem name="resourceName" label="资源名称" xtype="input" disabled labelCol={{ flex: '110px' }} />
